      ...
      <section className="relative overflow-hidden pt-28 pb-16 sm:pt-36 sm:pb-24 lg:pt-40 lg:pb-28">
        <div className="container grid items-center gap-8 sm:gap-10 lg:grid-cols-2">
          <div className="space-y-5 sm:space-y-6">
            ...
            >
              {t("home.headline1")} <span className="text-gradient">{t("home.headline2")}</span>
            </motion.h1>
            <motion.p
            ...
            <motion.div
              initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.2, ease }}
          ...
          <motion.div
            initial={{ opacity: 0, scale: 0.96 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.7, delay: 0.15, ease }}
            className="relative"
          >
